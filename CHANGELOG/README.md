...
|---------|-----------|------------------|
| Agents (Linux/Windows Installer & Forwarder) | [agents.md](agents.md) | 2026.07.09.19.55.08 |
| Backend (FastAPI API) | [backend.md](backend.md) | 2026.07.11.13.03.42 |
| Frontend (Vue UI) | [frontend.md](frontend.md) | 2026.07.11.13.03.42 |
