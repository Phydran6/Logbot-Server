...
**Aktuelle Projekt-/Release-Version:** `2026.09.15.20.00.00` (Datei `VERSION` im Wurzelverzeichnis, Root-README, `backend/app/config.py` → `app_version`, `frontend/package.json`, `install.sh` → `LOGBOT_VERSION`). Die Tabelle unten führt die Stände der einzelnen Bereiche.
Die Agents-README trägt `2026.09.15.20.00.00`.
...
|---------|-----------|------------------|
| Agents (Linux/Windows Installer & Forwarder) | [agents.md](agents.md) | 2026.09.15.20.00.00 |
| Backend (FastAPI API) | [backend.md](backend.md) | 2026.09.15.20.00.00 |
