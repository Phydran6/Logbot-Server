...
**Aktuelle Projekt-/Release-Version:** `2026.08.02.18.00.00` (Root-README, `backend/app/config.py` → `app_version`, `frontend/package.json`). Die Tabelle unten führt die Stände der einzelnen Bereiche.
...
| Backend (FastAPI API) | [backend.md](backend.md) | 2026.08.02.18.00.00 |
