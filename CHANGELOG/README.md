...
**Aktuelle Projekt-/Release-Version:** `2026.08.02.20.00.00` (Root-README, `backend/app/config.py` → `app_version`, `frontend/package.json`). Die Tabelle unten führt die Stände der einzelnen Bereiche.
...
| Backend (FastAPI API) | [backend.md](backend.md) | 2026.08.02.20.00.00 |
| Frontend (Vue UI) | [frontend.md](frontend.md) | 2026.08.02.18.00.00 |
| Syslog-Server | [syslog.md](syslog.md) | 2026.05.13.20.58.33 |
| Datenbank / Deployment (Postgres-Image, Compose, install.sh) | [database.md](database.md) | 2026.08.02.18.00.00 |
